"""Regression checks for the watch-sys-allocator-vault casebook."""
...
from casebook.harness import assert_expected, watch_sys_allocator_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_sys_allocator_vault_summary(), assert_expected())
